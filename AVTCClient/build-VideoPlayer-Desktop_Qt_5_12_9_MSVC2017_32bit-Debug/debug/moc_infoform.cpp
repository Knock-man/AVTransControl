...
#include "../../VideoPlayer/infoform.h"
...
QT_MOC_LITERAL(4, 32, 25), // "on_connectButton_released"
QT_MOC_LITERAL(5, 58, 23) // "on_closeButton_released"

    },
    "InfoForm\0button_clicked\0\0closed\0"
...
void InfoForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_closeButton_released(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InfoForm::button_clicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (InfoForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InfoForm::closed)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject InfoForm::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_InfoForm.data,
...
// SIGNAL 0
void InfoForm::button_clicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void InfoForm::closed()
{
